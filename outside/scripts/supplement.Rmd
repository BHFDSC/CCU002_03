...
```{r sex_dose1}
tmp <- df[df$dose=="Dose 1" & df$sex!="All" & df$prior_covid=="All" & df$outcome=="myocarditis/pericarditis" & df$age_group=="All",
          c("exposure","days_post_vaccination","sex","estimate","conf.low","conf.high","p.value")]
...
```{r sex_dose2}}
tmp <- df[df$dose=="Dose 2" & df$sex!="All" & df$prior_covid=="All" & df$outcome=="myocarditis/pericarditis" & df$age_group=="All",
          c("exposure","days_post_vaccination","sex","estimate","conf.low","conf.high","p.value")]
knitr::kable(tmp[order(tmp$exposure,tmp$days_post_vaccination,tmp$sex),], digits=2)
```
...
```{r age_dose1}
tmp <- df[df$dose=="Dose 1" & df$sex=="All" & df$prior_covid=="All" & df$outcome=="myocarditis/pericarditis" & df$age_group!="All",
          c("exposure","days_post_vaccination","age_group","estimate","conf.low","conf.high","p.value")]
...
```{r hetero_sex_dose1}
tmp <- df1[df1$dose=="Dose 1" & df1$interacting_feature=="Sex" & df1$outcome=="myocarditis/pericarditis",
...
```{r hetero_age_dose1}
tmp <- df1[df1$dose=="Dose 1" & df1$interacting_feature=="Age group" & df1$outcome=="myocarditis/pericarditis",
           c("exposure","days_post_vaccination","p.value")]
knitr::kable(tmp[order(tmp$exposure,tmp$days_post_vaccination),], digits=2)
```
...
```{r hetero_sex_dose2}
tmp <- df1[df1$dose=="Dose 2" & df1$interacting_feature=="Sex" & df1$outcome=="myocarditis/pericarditis",
           c("exposure","days_post_vaccination","p.value")]
knitr::kable(tmp[order(tmp$exposure,tmp$days_post_vaccination),], digits=2)
```
...
```{r hetero_age_dose2}
tmp <- df1[df1$dose=="Dose 2" & df1$interacting_feature=="Age group" & df1$outcome=="myocarditis/pericarditis",
           c("exposure","days_post_vaccination","p.value")]
knitr::kable(tmp[order(tmp$exposure,tmp$days_post_vaccination),], digits=2)
```
...
tmp <- tmp[,c("outcome","dose","exposure","days_post_vaccination","events")]
knitr::kable(tmp[order(tmp$outcome,tmp$dose,tmp$exposure),], digits=2)
```
...
tmp <- tmp[tmp$days_post_vaccination!="Before",
           c("outcome","dose","exposure","days_post_vaccination","estimate","conf.low","conf.high")]
knitr::kable(tmp[order(tmp$outcome,tmp$dose,tmp$exposure),], digits=2)
```
