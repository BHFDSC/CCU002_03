...
-- MAGIC gdppr_data = '.ccu002_03_gdppr_'
-- MAGIC skinny_data = '.ccu002_03_skinny_patient'
-- MAGIC death_data = '.ccu002_03_deaths_'
-- MAGIC sgss_data = '.ccu002_03_sgss_'
-- MAGIC 
-- MAGIC #Other data inputs
-- MAGIC conflicting_quality_assurance = '.ccu002_03_conflictingpatients'
-- MAGIC 
...
---%md %run "/Workspaces//ccu002_03c/Data_Curation/in_progress/CCU002-D03-quality_assurance_parameters_new"
...
LEFT JOIN .ccu002_03_conflictingpatients t2 ---those who didnt meet QA criteria, from the previous notebook
...
-- MAGIC %py
-- MAGIC 
-- MAGIC spark.sql(F"""DROP TABLE IF EXISTS .{final_table_1}""")

-- COMMAND ----------

-- MAGIC %py
-- MAGIC spark.sql(F"""CREATE TABLE .{final_table_1} AS 
-- MAGIC select *
