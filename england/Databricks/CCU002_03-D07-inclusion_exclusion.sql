...
-- MAGIC %md # CCU002_03-D07-inclusion_exclusion
-- MAGIC  
...
-- MAGIC gdppr_data = 'dars_nic_391419_j3w9t_collab.ccu002_03_gdppr_dars_nic_391419_j3w9t'
-- MAGIC skinny_data = 'dars_nic_391419_j3w9t_collab.ccu002_03_skinny_patient'
-- MAGIC death_data = 'dars_nic_391419_j3w9t_collab.ccu002_03_deaths_dars_nic_391419_j3w9t'
-- MAGIC sgss_data = 'dars_nic_391419_j3w9t_collab.ccu002_03_sgss_dars_nic_391419_j3w9t'
-- MAGIC 
-- MAGIC #Other data inputs
-- MAGIC conflicting_quality_assurance = 'dars_nic_391419_j3w9t_collab.ccu002_03_conflictingpatients'
-- MAGIC 
-- MAGIC #Date parameters
-- MAGIC index_date = '2020-12-08'
-- MAGIC 
-- MAGIC #Final table name
-- MAGIC final_table_1 = 'ccu002_03_included_patients'
...
---%md %run "/Workspaces/dars_nic_391419_j3w9t_collab/ccu002_03c/Data_Curation/in_progress/CCU002-D03-quality_assurance_parameters_new"
...
LEFT JOIN dars_nic_391419_j3w9t_collab.ccu002_03_conflictingpatients t2 ---those who didnt meet QA criteria, from the previous notebook
...
-- MAGIC #Known sex and age 12 and over -- people who have not died before 8th Dec 2020 and who have SEX==1/2 and who are 12+
-- MAGIC spark.sql(F"""create or replace global temp view patientinclusion AS 
-- MAGIC 
-- MAGIC SELECT *
-- MAGIC FROM global_temp.skinny_withQA 
-- MAGIC WHERE nhs_number_deid is not null 
-- MAGIC AND AGE_AT_COHORT_START >=12
