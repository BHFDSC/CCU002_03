...
# MAGIC %md # CCU002_03-D06-quality_assurance
# MAGIC  
...
# MAGIC final_table = 'ccu002_03_conflictingpatients'
...
preg = spark.sql("SELECT * FROM dars_nic_391419_j3w9t_collab.ccu002_03_codelists WHERE name = 'pregnancy_and_birth'")
...
create_table(df_gdppr_sex, table_name="ccu002_03_df_gdppr_sex")
...
pros = spark.sql("SELECT * FROM dars_nic_391419_j3w9t_collab.ccu002_03_codelists WHERE name = 'prostate_cancer'")
pros = [item.code for item in pros.select('code').collect()]

# COMMAND ----------

df_gdppr = spark.table("dars_nic_391419_j3w9t_collab.ccu002_03_df_gdppr_sex") # created for rule 6, no need to re-do
