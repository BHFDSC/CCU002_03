...
# MAGIC FROM .ccu002_03_included_patients AS cohort
# MAGIC LEFT JOIN .ccu002_03_vaccination AS vaccination ON cohort.NHS_NUMBER_DEID = vaccination.NHS_NUMBER_DEID
# MAGIC LEFT JOIN .ccu002_03_out_dose1_any_myocarditis AS out_dose1_any_myocarditis ON cohort.NHS_NUMBER_DEID = out_dose1_any_myocarditis.NHS_NUMBER_DEID
# MAGIC LEFT JOIN .ccu002_03_out_dose1_any_pericarditis AS out_dose1_any_pericarditis ON cohort.NHS_NUMBER_DEID = out_dose1_any_pericarditis.NHS_NUMBER_DEID
# MAGIC LEFT JOIN .ccu002_03_out_dose2_any_myocarditis AS out_dose2_any_myocarditis ON cohort.NHS_NUMBER_DEID = out_dose2_any_myocarditis.NHS_NUMBER_DEID
# MAGIC LEFT JOIN .ccu002_03_out_dose2_any_pericarditis AS out_dose2_any_pericarditis ON cohort.NHS_NUMBER_DEID = out_dose2_any_pericarditis.NHS_NUMBER_DEID
# MAGIC LEFT JOIN .ccu002_03_cov_dose1_lsoa AS cov_dose1_lsoa ON cohort.NHS_NUMBER_DEID = cov_dose1_lsoa.NHS_NUMBER_DEID
# MAGIC LEFT JOIN .ccu002_03_cov_dose1_region AS cov_dose1_region ON cov_dose1_lsoa.cov_dose1_lsoa = cov_dose1_region.LSOA
# MAGIC LEFT JOIN .ccu002_03_cov_dose1_deprivation AS cov_dose1_deprivation ON cov_dose1_lsoa.cov_dose1_lsoa = cov_dose1_deprivation.LSOA
# MAGIC LEFT JOIN .ccu002_03_cov_dose1_pericarditis AS cov_dose1_pericarditis ON cohort.NHS_NUMBER_DEID = cov_dose1_pericarditis.NHS_NUMBER_DEID
# MAGIC LEFT JOIN .ccu002_03_cov_dose1_myocarditis AS cov_dose1_myocarditis ON cohort.NHS_NUMBER_DEID = cov_dose1_myocarditis.NHS_NUMBER_DEID
# MAGIC LEFT JOIN .ccu002_03_cov_dose1_prior_covid19 AS cov_dose1_prior_covid19 ON cohort.NHS_NUMBER_DEID = cov_dose1_prior_covid19.NHS_NUMBER_DEID
# MAGIC LEFT JOIN .ccu002_03_cov_dose2_lsoa AS cov_dose2_lsoa ON cohort.NHS_NUMBER_DEID = cov_dose2_lsoa.NHS_NUMBER_DEID
# MAGIC LEFT JOIN .ccu002_03_cov_dose2_region AS cov_dose2_region ON cov_dose2_lsoa.cov_dose2_lsoa = cov_dose2_region.LSOA
# MAGIC LEFT JOIN .ccu002_03_cov_dose2_deprivation AS cov_dose2_deprivation ON cov_dose2_lsoa.cov_dose2_lsoa = cov_dose2_deprivation.LSOA
# MAGIC LEFT JOIN .ccu002_03_cov_dose2_pericarditis AS cov_dose2_pericarditis ON cohort.NHS_NUMBER_DEID = cov_dose2_pericarditis.NHS_NUMBER_DEID
# MAGIC LEFT JOIN .ccu002_03_cov_dose2_myocarditis AS cov_dose2_myocarditis ON cohort.NHS_NUMBER_DEID = cov_dose2_myocarditis.NHS_NUMBER_DEID
# MAGIC LEFT JOIN .ccu002_03_cov_dose2_prior_covid19 AS cov_dose2_prior_covid19 ON cohort.NHS_NUMBER_DEID = cov_dose2_prior_covid19.NHS_NUMBER_DEID
