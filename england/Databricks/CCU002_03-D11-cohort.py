...
# MAGIC LEFT JOIN .ccu002_03_out_any_myocarditis AS out_any_myocarditis ON cohort.NHS_NUMBER_DEID = out_any_myocarditis.NHS_NUMBER_DEID
# MAGIC LEFT JOIN .ccu002_03_out_any_pericarditis AS out_any_pericarditis ON cohort.NHS_NUMBER_DEID = out_any_pericarditis.NHS_NUMBER_DEID
# MAGIC LEFT JOIN .ccu002_03_cov_lsoa AS cov_lsoa ON cohort.NHS_NUMBER_DEID = cov_lsoa.NHS_NUMBER_DEID
# MAGIC LEFT JOIN .ccu002_03_cov_region AS cov_region ON cov_lsoa.LSOA = cov_region.LSOA
# MAGIC LEFT JOIN .ccu002_03_cov_deprivation AS cov_deprivation ON cov_lsoa.LSOA = cov_deprivation.LSOA
# MAGIC LEFT JOIN .ccu002_03_cov_pericarditis AS cov_pericarditis ON cohort.NHS_NUMBER_DEID = cov_pericarditis.NHS_NUMBER_DEID
# MAGIC LEFT JOIN .ccu002_03_cov_myocarditis AS cov_myocarditis ON cohort.NHS_NUMBER_DEID = cov_myocarditis.NHS_NUMBER_DEID
# MAGIC LEFT JOIN .ccu002_03_cov_prior_covid19 AS cov_prior_covid19 ON cohort.NHS_NUMBER_DEID = cov_prior_covid19.NHS_NUMBER_DEID
