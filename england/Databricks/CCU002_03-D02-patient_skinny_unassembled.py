...
# %run "/Workspaces//CCU002_vacc/Data_Curation/in_progress/CCU002_vacc_functions/wrang000_functions
...
database_name, collab_database_name, datawrang_database_name = database_widgets(database_name = '', collab_database_name='');
...
# MAGIC           ) all_patients 
# MAGIC           --LEFT JOIN .deaths_ death on all_patients.NHS_NUMBER_DEID = death.DEC_CONF_NHS_NUMBER_CLEAN_DEID
# MAGIC     )
