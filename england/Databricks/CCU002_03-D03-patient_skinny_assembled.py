...
# MAGIC %run Workspaces//CCU002_03/functions/wrang000_functions
...
dbutils.notebook.run("/Workspaces//CCU002_03/CCU002_03-D02-patient_skinny_unassembled",3000)
...
spark.sql(F"""DROP TABLE IF EXISTS .{skinny_table_name}""")
