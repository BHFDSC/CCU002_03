...
# MAGIC %md # CCU002_03-D03-patient_skinny_assembled
# MAGIC 
# MAGIC **Description** Making a single record for each patient in primary and secondary care. This uses the output from **CCU002_03-D02-patient_skinny_unassembled**
# MAGIC  
...
# MAGIC %run Workspaces/dars_nic_391419_j3w9t_collab/CCU002_03/functions/wrang000_functions
...
gdppr_data = 'dars_nic_391419_j3w9t_collab.ccu002_03_gdppr_dars_nic_391419_j3w9t'

#Date Parameters
index_date = '2020-12-08'

#Data output name
skinny_table_name = 'ccu002_03_skinny_patient' 
...
dbutils.notebook.run("/Workspaces/dars_nic_391419_j3w9t_collab/CCU002_03/CCU002_03-D02-patient_skinny_unassembled",3000)
