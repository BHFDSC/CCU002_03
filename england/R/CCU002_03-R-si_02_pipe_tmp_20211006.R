...
master_df_fpath <- "~//CCU002_03/data/ccu002_03_cohort_20211006.csv.gz"
# if (dose_str == "dose2"){
#   master_df_fpath <- "~//CCU002_03/data/ccu002_03_cohort_20210915.csv.gz"
# } else if (dose_str == "dose1"){
#   master_df_fpath <- "~//CCU002_03/data/ccu002_03_cohort_firstdose_20210924.csv.gz"
#   vaccination_dose2_date_fpath <- "~//CCU002_03/data/ccu002_03_cohort_20210915.csv.gz"
#   }
# old_master_df_fpath <- "~//CCU002_02/data/ccu002_vacc_cohort.csv.gz" # was for region 
